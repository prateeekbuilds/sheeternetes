...
[`good first issue`](https://github.com/tym83/sheeternetes/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22).
Pick one, open a PR, and earn a place in the [SNCF Landscape](https://tym83.github.io/sheeternetes/landscape.html).
...
### 💭 DR from Sheets revision history · [#12](https://github.com/tym83/sheeternetes/issues/12)
Restore a "cluster" from Google Sheets' version history. RPO measured in Ctrl+Z.

## Storage

### 💭 Sheetstor — distributed block storage (LINSTOR analog) · [#30](https://github.com/tym83/sheeternetes/issues/30)
...
### 💭 Sheetelligence — prompt-native orchestration · [#22](https://github.com/tym83/sheeternetes/issues/22)
Describe a workload in plain English in a cell; an LLM fills in the manifest rows.

### 💭 SheetAIOps — anomaly detection · [#23](https://github.com/tym83/sheeternetes/issues/23)
Watch the Events tab; predict failures with total confidence and no accountability.

## WebAssembly

### 💭 SheetAssembly — schedule WASI/WASM workloads · [#24](https://github.com/tym83/sheeternetes/issues/24)
A "pod" can be a WASM module; kubelet runs it via wasmtime instead of `docker run`.

### 💭 skctl-wasm — the CLI in the browser · [#25](https://github.com/tym83/sheeternetes/issues/25)
Compile skctl to WebAssembly and run it client-side against the apiserver.

## Operating system

### 💭 SheetOS — Talos for spreadsheets · [#26](https://github.com/tym83/sheeternetes/issues/26)
...
### ⚪ Lisp client · [#29](https://github.com/tym83/sheeternetes/issues/29)
Homoiconic orchestration from the REPL. _Proposed by the community._

### ⚪ Brainfuck client · [#28](https://github.com/tym83/sheeternetes/issues/28)
...
### ⚪ Establish the SNCF org &amp; split into components · [#33](https://github.com/tym83/sheeternetes/issues/33)
...
### ⚪ Extract Sheetlium (Cilium analog) · [#31](https://github.com/tym83/sheeternetes/issues/31)
Networking as its own component.

### ⚪ Extract Sheetlux CD (Argo CD analog) · [#32](https://github.com/tym83/sheeternetes/issues/32)
GitOps delivery as its own component.

## How to influence the roadmap
Browse the [open proposals](https://github.com/tym83/sheeternetes/issues) and open a PR
against one, or open a new issue tagged [`sncf`](https://github.com/tym83/sheeternetes/issues?q=is%3Aissue+label%3Asncf).
